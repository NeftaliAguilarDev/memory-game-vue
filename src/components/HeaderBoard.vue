...
<template>
    <div class="flex flex-col md:flex-row justify-between items-center sm:mt-10 fixed sm:static top-0 py-5 left-0 z-50 w-full bg-white">
        ...
        <div>
            <ol class="grid grid-cols-2 lg:grid-cols-4 p-5 rounded-md text-white text-center gap-5 bg-green-modyo">
                ...
                <li>Time: <span>{{ time }} {{ time > 1 ? 'seconds' : 'second'  }}</span></li>
            </ol>
        </div>
    </div>
</template>
